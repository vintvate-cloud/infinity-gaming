      ...
      <div className="section-inner" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '2rem' }}>
          {tournaments.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '4rem 2rem', background: 'var(--surface-2)', borderRadius: 'var(--radius-lg)', border: '1px dashed var(--border-md)', color: 'var(--grey-1)', gridColumn: '1 / -1' }}>
              <div style={{ fontSize: '2rem', marginBottom: '1rem' }}>🎮</div>
              <h3 style={{ fontSize: '1.2rem', color: 'var(--white)', marginBottom: '0.5rem' }}>No Upcoming Tournaments</h3>
              <p>Check back later for new events, or ask our staff at the lounge!</p>
            </div>
          ) : (
